...
class __TwigTemplate_b9b8883369ffd1f01dfb8efbbbf156ac extends Template
{
...
($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "/var/www/sites/voorjongnederland.nl/web/core/themes/olivero/templates/filter/filter-tips.html.twig");
    }
